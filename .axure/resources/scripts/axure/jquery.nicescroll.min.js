    ...
    x = function (e, p) {
                ...
                if (
                  ...
                  if (
                    ...
                    m.rail.scrollable && !m.railh.scrollable
                      ? (m.rail.drag.ck = a > 0 && "v")
                      : !m.rail.scrollable && m.railh.scrollable
                        ? (m.rail.drag.ck = d > 0 && "h")
                        : (m.rail.drag.ck = !1);
                  }
                  if (g.emulatetouch && m.isiframe && T.isie) {
                    var u = m.win.position();
                    (m.rail.drag.x += u.left), (m.rail.drag.y += u.top);
                  }
                  if (
                    ((m.hasmoving = !1),
                    (m.lastmouseup = !1),
              ...
              (m.ontouchmove = function (e, o) {
                ...
                if (2 == m.rail.drag.pt) {
                  ...
                  var s = e.clientY + t,
                    n = s - m.rail.drag.y,
                    a = e.clientX + r;
                  g.horizrailenabled || (a = 0 + r);
                  var c = a - m.rail.drag.x,
                    d = m.rail.drag.st - n;
                  ...
                  if (
                    ...
                    g.horizrailenabled
                      ...
                      : m.triggerScrollStart(0, e.clientY, 0, 0, 0),
                      (m.hasmoving = !0);
                  }
                  return (
                    m.preventclick &&
              ...
              (m.onmousemove = function (e) {
                if (m.rail.drag) {
                  ...
                  if (
                    ...
                    if (g.horizrailenabled) {
                      (m.scroll.x =
                        m.rail.drag.sx + (e.clientX - m.rail.drag.x)),
                        m.scroll.x < 0 && (m.scroll.x = 0);
                      var o = m.scrollvaluemaxw;
                      m.scroll.x > o && (m.scroll.x = o);
                    }
      ...
      if (T.haseventlistener) {
        try {
          ...
          a.addEventListener("test", null, _);
        } catch (e) {}
      ...
      (this.delegate = function (e, o, t, r, i) {
        ...
        (this.remove = function () {
          m.stop(), m.cursortimeout && clearTimeout(m.cursortimeout);
          for (var e in m.delaylist) m.delaylist[e] && h(m.delaylist[e].h);
          m.doZoomOut(),
            m.unbindAll(),
            T.isie9 &&
          ...
          for (var i in m) (m[i] = null), delete m[i];
          m = null;
        }),
